#!/usr/bin/env python3
"""Resolve the npm version for @krypticdev/daemon-client.
...
PACKAGE_ID = "@krypticdev/daemon-client"
REGISTRY_URL = "https://registry.npmjs.org/@krypticdev%2fdaemon-client"
